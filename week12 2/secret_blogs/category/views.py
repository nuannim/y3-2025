...
class CategoryListView(View):
    permission_required = ["category.view_blog"]
...
class CategoryCreateView(View):
    permission_required = ["category.add_blog"]
...
class CategoryEditView(View):
    permission_required = ["category.change_blog"]
...
class CategoryDeleteView(View):
    permission_required = ["category.delete_blog"]
